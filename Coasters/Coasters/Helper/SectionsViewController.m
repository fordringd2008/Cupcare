...
- (void)viewDidLoad {
    ...
    [navigationBar setBackgroundImage:ConnectImg forBarMetrics:UIBarMetricsDefault];
    UINavigationItem *navigationItem = [[UINavigationItem alloc] initWithTitle:@""];
    UILabel *lblTitle = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 100, 30)];
    lblTitle.text = kString(@"选择国家或地区");
    ...
    button.frame = CGRectMake(0, 0, 10, 22);
    ...
    [button setTitle:kString(@"返回") forState: UIControlStateNormal];
